...
kernel void concat_89fe84c3f80b192cf090a966013f7504977384badd8e1c5ef68ae7ec(device float * static_buffer[[buffer(0)]],
                          device float * dynamic_buffer[[buffer(1)]],
                          const device int * meta_buffer [[buffer(2)]],
                          ...
                          uint num_threads[[threads_per_grid]])
{
    ...
    const device int *y_offsets = (&(meta_buffer[15]));
    const device int *x_shapes = (&(meta_buffer[11]));
...
kernel void fusedelementwise_7fc9a0d11a5e793e5a5985db1aebb6121d39b574f9a91aa9f4b370a3(device float * static_buffer[[buffer(0)]],
                          device float * dynamic_buffer[[buffer(1)]],
                          const device int * meta_buffer [[buffer(2)]],
                          uint gid[[thread_position_in_grid]],
                          uint num_threads[[threads_per_grid]])
...
kernel void fusedelementwise_6aa428c71ecd91967d0b4e9658d795ff25fd6b761e149b416a802110(device float * static_buffer[[buffer(0)]],
                          device float * dynamic_buffer[[buffer(1)]],
                          const device int * meta_buffer [[buffer(2)]],
                          uint gid[[thread_position_in_grid]],
                          uint num_threads[[threads_per_grid]])
...
kernel void fusedelementwise_8f670c28fc196e56c6a5dbb62dc89735b498bebb8f18c0c35e2ca5ea(device float * static_buffer[[buffer(0)]],
                          device float * dynamic_buffer[[buffer(1)]],
                          const device int * meta_buffer [[buffer(2)]],
                          uint gid[[thread_position_in_grid]],
                          uint num_threads[[threads_per_grid]])

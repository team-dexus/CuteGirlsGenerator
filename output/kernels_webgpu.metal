...
kernel void fusedelementwise_331a7abcd509ed18806a74fc4797c5edcae831cb2e7fab6d8ea65af6(device float * static_buffer[[buffer(0)]],
                          device float * dynamic_buffer[[buffer(1)]],
                          const device int * meta_buffer [[buffer(2)]],
                          uint gid[[thread_position_in_grid]],
                          uint num_threads[[threads_per_grid]])
...
kernel void fusedelementwise_f05a98db5acf3ccfd515263711e9e33cdef8478d5296485a8acca780(device float * static_buffer[[buffer(0)]],
                          device float * dynamic_buffer[[buffer(1)]],
                          const device int * meta_buffer [[buffer(2)]],
                          uint gid[[thread_position_in_grid]],
                          uint num_threads[[threads_per_grid]])
